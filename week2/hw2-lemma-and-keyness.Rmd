...
textplot_keyness(result, n = 20, 
  ...
  scale_fill_manual(values = c("grey", "hotpink"), 
                    labels = c("CE Noticias Financieras English", "The New York Times"))
```
